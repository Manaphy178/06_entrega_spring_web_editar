...
<label for="nombre">Nombre:</label
      ><input type="text" name="nombre" id="nombre" value="${instrumento.nombre }"/><br />
      <label for="tipo">Tipo:</label
      ><input type="text" name="tipo" id="tipo" value="${instrumento.tipo }"/><br />
      <label for="marca">Marca:</label
      ><input type="text" name="marca" id="marca" value="${instrumento.marca }"/><br />
